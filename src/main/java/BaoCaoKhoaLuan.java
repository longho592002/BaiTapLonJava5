...
public class BaoCaoKhoaLuan extends BaoCao {
    ...
    private ArrayList<TvHoiDong> listTV = new ArrayList<>();
    ...
    public BaoCaoKhoaLuan(String maBaoCao, String tenBaoCao, String linkBaoCao, String ngayBaoCao, String dsSinhVien, String tenGiangVien, double diemBaoCao, double tyLeDaoVan) throws ParseException {
        super(maBaoCao, tenBaoCao, linkBaoCao, ngayBaoCao, dsSinhVien, tenGiangVien, diemBaoCao);
...
//    public double getDiemTongKet(double diemTongKet) {
